...
class TeestViewController: UIViewController {
    ...
    var questions: [Questions] = [] // Lista de preguntas
    ...
    override func viewDidLoad() {
        ...
        questions = [
            Questions(text: "¿Cómo te sientes últimamente para realizar las cosas?", answers: [
            ...
            Questions(text: "¿Qué situaciones has experimentado en las últimas semanas?", answers: [
            ...
            Questions(text: "¿Qué sentimiento es el que más deseas experimentar en tu vida?", answers: [
                "Tranquilidad, confianza en mí mismo(a)",
                "Relajado(a) y enérgico(a)",
                "Satisfacción y felicidad"
            ], scores: [3, 2, 1]),
            Questions(text: "¿Qué  vida?", answers: [
            ...
            Questions(text: "¿Cómo describiría tu comportamiento en estas últimas semanas?", answers: [
